    ...
    return (
        <div className="pb-12 space-y-8 animate-in fade-in duration-500">
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm text-center">
                ...
                <h1 className="text-3xl font-black text-gray-900 mb-2">The Cookbook</h1>
                <p className="text-gray-500 mb-6">Explore our entire collection of culinary masterpieces.</p>
                ...
                <div className="max-w-md mx-auto relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 outline-none transition"
                    />
                </div>
            </div>
